...
\usepackage[left=0.55in,right=0.55in,top=0.42in,bottom=0.42in]{geometry}
\usepackage{titlesec}
\usepackage{enumitem}
\usepackage{hyperref}
...
\titlespacing*{\section}{0pt}{0.58em}{0.36em}

% 列表样式
\setlist[itemize]{leftmargin=1.18em, itemsep=0.08em, parsep=0pt, topsep=2pt}
...
\begin{document}
\fontsize{10.85}{12.35}\selectfont
